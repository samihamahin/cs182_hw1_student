...
def rmsprop(x, dx, config=None):
    ...
    velocity = config['cache']
    
    velocity = beta*velocity + (1- beta)*(dx**2)
    next_x = x - learning_rate/(np.sqrt(velocity) + epsilon) * dx
    
    config['cache'] =velocity
    #############################################################################
    #                             END OF YOUR CODE                              #
    #############################################################################
